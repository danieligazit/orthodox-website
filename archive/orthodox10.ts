...
// CHANGED: Reduced from 800 to 600 for a snappier intro
      ...
      <div className={`relative z-20 transition-opacity duration-500 ${selectedAlbum ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <main className="w-full">
            ...
            <div 
                ...
                style={{ 
                    // CHANGED: Overlaps animation. Starts appearing at 50% scroll.
                    opacity: contentOpacity,
                    // CHANGED: Reduced travel distance (50px) for faster settling.
