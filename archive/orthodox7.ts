...
export default function OrthodoxLabel() {
  ...
  // Fade in the black square background towards the end of the animation
  const squareOpacity = Math.max(0, (easeProgress - 0.5) * 2);
            ...
            >
                ...
                <div 
                    ...
                    style={{
                        width: '1.25em', 
                        height: '1.25em',
                        // Animate solid black background opacity
                        backgroundColor: `rgba(5,5,5, ${squareOpacity})`,
                        // Optional: Border to make the square visible against the black header
                        border: `1px solid rgba(255,255,255, ${squareOpacity * 0.2})` 
                    }}
                >
